...
model = dict(
    ...
    img_backbone=dict(
        ...
        arch='base',
        init_cfg=dict(
            type='Pretrained', checkpoint='ckpts/convnext-base_3rdparty_in21k_20220124-13b83eec.pth',
            prefix='backbone.'),
        out_indices=[2, 3],
...
custom_hooks = [
    dict(
        ...
        init_updates=10560,
        priority='NORMAL',
        resume='/mount/data/lsbevv2/work_dirs/convnext-b-depth-cbgs_t2_init_debug_one_neck/epoch_12_ema.pth'
    ),
    dict(
...
load_from = 'ckpts/convnext-b-21k.pth'
