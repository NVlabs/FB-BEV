                    ...
                    attn_cfgs=[
                        ...
                        dict(
                            ...
                            deformable_attention=dict(
                                type='MSDeformableAttention3D_v2',
                                embed_dims=_dim_,
                                num_points=8,
...
custom_hooks = [
    dict(
        ...
        init_updates=10560,
        priority='NORMAL',
        # resume='/mount/data/lsbevv2/work_dirs/lsbev4d-r101-depth-cbgs_t2_init_debug_one_neck/epoch_11_resume_ema.pth'
    ),
    dict(
...
load_from = '/mount/data/lsbevv2/work_dirs/lsbev4d-r101-depth-cbgs_t2_init_debug_one_neck/epoch_11_resume.pth'
