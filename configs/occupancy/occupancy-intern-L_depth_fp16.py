...
train_pipeline = [
    ...
    dict(type='LoadOccupancy', ignore_nonvisible=True, filter_lidar_points=False),
...
custom_hooks = [
    dict(
        ...
        init_updates=10560,
        priority='NORMAL',
        resume='/mount/data/lsbevv2/work_dirs/occupancy-intern-L_depth_fp16/epoch_2_ema.pth'
    ),
]
